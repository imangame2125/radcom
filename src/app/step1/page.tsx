...
const Step1 = () => {
  ...
  function handleNext() {
    ...
    router.push(
      "/step2?row=" + dimensions.row + "&column=" + dimensions.column
    );
  }
  ...
  return (
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        <label className="text-2xl font-bold text-center sm:text-left">
          سطر
        </label>
        <input
          ...
          type="number"
          className="w-full sm:w-[400px] h-12 px-4 text text-gray-900 bg-white border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
          placeholder="Enter a number"
        />
        <p className="text-red-500">
          {dimensionsError.row && "عدد باید فرد و بزرگتر از ۳ باشد"}
        </p>
